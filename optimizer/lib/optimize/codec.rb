...
# Optimize::Codec — decode and encode the YARB ("YARV Binary Format")
# produced by RubyVM::InstructionSequence#to_binary.
#
# Public API:
#
#   Optimize::Codec.decode(binary) -> IR::Function
#     Parses a YARB blob into an IR::Function whose #children lists
#     the outer iseqs.
#
#   Optimize::Codec.encode(ir) -> String
...
require "optimize/codec/iseq_list"
