...
**Files:**
- Create: `optimizer/lib/ruby_opt/passes/arith_reassoc_pass.rb`
...
Expected: `cannot load such file -- ruby_opt/passes/arith_reassoc_pass`.

- [ ] **Step 3: Implement the pass** — `optimizer/lib/ruby_opt/passes/arith_reassoc_pass.rb`
...
- [ ] **Step 3: Update `Pipeline.default`** — `optimizer/lib/ruby_opt/pipeline.rb`
...
(Files: `optimizer/lib/ruby_opt/pipeline.rb`, `optimizer/test/passes/arith_reassoc_pass_corpus_test.rb`.)
